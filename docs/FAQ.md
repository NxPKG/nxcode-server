...
<https://github.com/nxpkg/code-server/discussions>.
...
1. [Live Share](https://visualstudio.microsoft.com/services/live-share). We may
   ...
   [#33](https://github.com/nxpkg/code-server/issues/33))
1. [Remote Extensions (SSH, Containers,
   ...
   ([#1315](https://github.com/nxpkg/code-server/issues/1315)).
...
See [#2794](https://github.com/nxpkg/code-server/issues/2794) for additional context.
...
Eventually, [#1636](https://github.com/nxpkg/code-server/issues/1636) will make
this process better.
...
code-server was built for individuals while Coder was built for teams. In Coder, you create Workspaces which can have applications like code-server. If you're looking for a team solution, you should reach for [Coder](https://github.com/nxpkg/coder).
...
- [Some other things](https://github.com/nxpkg/code-server/tree/main/patches)
...
Visit the [awesome-code-server](https://github.com/nxpkg/awesome-code-server)
