...
script](https://github.com/nxpkg/code-server/blob/main/install.sh) for Linux, macOS and FreeBSD. The install script
...
information on how to do this. The [`install.sh`](https://github.com/nxpkg/code-server/blob/main/install.sh) script runs the
...
4. You're running Alpine Linux or are using a non-glibc libc. See
   [#1430](https://github.com/nxpkg/code-server/issues/1430#issuecomment-629883198)
...
[GitHub](https://github.com/nxpkg/code-server/releases). The archives bundle the
...
1. Download the latest release archive for your system from
   [GitHub](https://github.com/nxpkg/code-server/releases).
...
curl -fL https://github.com/nxpkg/code-server/releases/download/v$VERSION/code-server-$VERSION-linux-amd64.tar.gz \
  | tar -C ~/.local/lib -xz
...
```bash
curl -fOL https://github.com/nxpkg/code-server/releases/download/v$VERSION/code-server_${VERSION}_amd64.deb
...
```bash
curl -fOL https://github.com/nxpkg/code-server/releases/download/v$VERSION/code-server-$VERSION-amd64.rpm
...
releases](https://github.com/nxpkg/code-server/issues/1397). We recommend
...
If you see an error related to `node-gyp` during installation, See [#5174](https://github.com/nxpkg/code-server/issues/5174) for more information.
...
providers](https://github.com/nxpkg/deploy-code-server) such as DigitalOcean,
