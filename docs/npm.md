...
> code-server release, and [might lead to unexpected behavior](https://github.com/nxpkg/code-server/issues/4927).
...
behavior](https://github.com/nxpkg/code-server/issues/1633).
...
For help and additional troubleshooting, see [#1397](https://github.com/nxpkg/code-server/issues/1397).
...
page](https://github.com/nxpkg/code-server/discussions).
